...
exports.propertyDetail = async (req, res) => {
	try {
		...
		return res.status(200).send({
		    "status": true,
			"status_code": "200",
			"message": "Supervisor property details",
		    data: [{
...
exports.propertyWingList = async (req, res) => {
	try {
		...
		return res.status(200).send({
		    "status": true,
			"status_code": "200",
			"message": "Supervisor property wing list",
		    data: wingsData
		});
	} catch (error) {
		console.log(error);
...
exports.categoryCheckList = async (req, res) => {
	try {
		...
		return res.status(200).send({
		    "status": true,
		    "status_code": "200",
			"message": "Category wise check list",
...
exports.userDetail = async (req, res) => {
	try {
		...
		let usedCategory = await Task.distinct( "categoryId", query);
